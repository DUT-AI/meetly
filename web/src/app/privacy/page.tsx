    ...
    <main className="min-h-screen bg-slate-50 text-slate-800">
      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4 sm:px-6">
          ...
          <Link
            href="/"
            className="rounded-lg bg-indigo-50 px-3 py-1.5 text-sm font-medium text-indigo-600 transition hover:bg-indigo-100"
          >
            Quay lại trang chủ
          </Link>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-10">
          <div className="border-b border-slate-100 pb-6">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Cập nhật lần cuối: Ngày 19 tháng 09 năm 2026 • Last updated: September 19, 2026
            </p>
          </div>
          ...
          <div className="prose prose-slate max-w-none pt-6 text-sm leading-relaxed sm:text-base">
            <section className="mb-8">
              ...
              <p>
                Tiện ích mở rộng <strong>Meetly - Audio Recorder for Google Meet</strong> do đội ngũ Meetly phát triển cam kết tôn trọng và bảo vệ tuyệt đối quyền riêng tư của người dùng. Chính sách này giải thích cách tiện ích xử lý dữ liệu khi bạn cài đặt và sử dụng.
              </p>
              <p className="italic text-slate-600">
                Meetly (&quot;we&quot;, &quot;our&quot;) is committed to protecting your privacy. This policy outlines how &quot;Meetly - Audio Recorder for Google Meet&quot; handles information during your usage.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>
                Mục đích duy nhất của tiện ích là hỗ trợ người dùng <strong>ghi âm âm thanh cuộc họp Google Meet hai chiều</strong> (âm thanh từ các thành viên trong cuộc họp và giọng nói qua micro của chính bạn) và lưu file âm thanh trực tiếp về máy tính cá nhân để phục vụ cho việc ghi chép, tóm tắt và quản lý công việc trên Meetly.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc space-y-2 pl-5">
                <li>
                  <strong>Âm thanh cuộc họp & Micro:</strong> Tiện ích chỉ thu nhận âm thanh khi bạn chủ động nhấn nút &quot;Ghi âm cuộc họp&quot;. Quá trình trộn luồng (Web Audio API) và nén thành định dạng <code>.webm</code> diễn ra <strong>hoàn toàn trên trình duyệt tại máy tính của bạn</strong>.
                </li>
                <li>
                  <strong>Lưu file trực tiếp:</strong> Khi kết thúc, file âm thanh được tải thẳng về thư mục <code>Downloads</code> trên máy tính cá nhân của bạn.
                </li>
                <li>
                  <strong>Không truyền dữ liệu ra bên ngoài:</strong> Tiện ích <strong>không gửi</strong> âm thanh cuộc họp đến bất kỳ máy chủ bên thứ ba nào hoặc máy chủ theo dõi quảng cáo.
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>Chúng tôi cam kết <strong>KHÔNG</strong> thu thập:</p>
            ...
            <section className="mb-8">
              ...
              <p>
                Chúng tôi tuân thủ nghiêm ngặt Chính sách dành cho nhà phát triển của Cửa hàng Chrome trực tuyến (Chrome Web Store Developer Program Policies):
              </p>
              <ul className="list-disc space-y-1 pl-5">
            ...
            <section className="mb-8">
              ...
              <p>
                Vì toàn bộ file ghi âm được lưu trữ trực tiếp trên thiết bị của bạn, bạn nắm toàn quyền kiểm soát dữ liệu của mình. Bạn có thể mở nghe, sao chép hoặc xóa vĩnh viễn các file này khỏi máy tính bất cứ lúc nào.
              </p>
            </section>
