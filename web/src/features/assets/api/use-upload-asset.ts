...
export const useUploadAsset = () => {
  ...
  return useMutation({
    mutationFn: async ({ workspaceId, entityType, entityId, file, onProgress }: UploadAssetParam) => {
      return await assetApi.uploadAsset(workspaceId, entityType, entityId, file, onProgress);
    },
