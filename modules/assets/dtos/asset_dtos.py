...
class AssetResponseDTO(BaseModel):
    ...
    entity_type: str = Field(
        ..., description="Polymorphic entity type (e.g. TASK, COMMENT)"
    )
    ...
    download_url: str | None = Field(
        None, description="Presigned download URL or public URL"
    )
    preview_url: str | None = Field(
        None, description="Preview / thumbnail URL if available"
    )
